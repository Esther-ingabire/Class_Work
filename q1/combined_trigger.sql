-- Combined Trigger: Logs violations AND blocks access
-- This ensures logging happens before blocking

-- Drop both separate triggers
DROP TRIGGER trg_access_enforcement;
DROP TRIGGER trg_violation_logger;

-- Create single trigger that does both functions
CREATE OR REPLACE TRIGGER trg_auca_policy
